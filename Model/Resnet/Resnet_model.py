...
class ResNet18(nn.Module):
    def __init__(self, in_channels=3, resblock=ResBlock, outputs=2,width=7):
        super().__init__()
        ...
        self.layer1 = nn.Sequential(
            resblock(64, 64, downsample=True,width=width),
            resblock(64, 64, downsample=False,width=width)
        )

        self.layer2 = nn.Sequential(
            resblock(64, 128, downsample=False,width=width),
            resblock(128, 128, downsample=False,width=width)
        )

        self.layer3 = nn.Sequential(
            resblock(128, 256, downsample=True,width=width),
            resblock(256, 256, downsample=False,width=width)
        )


        self.layer4 = nn.Sequential(
            resblock(256, 512, downsample=False,width=width),
            resblock(512, 512, downsample=False,width=width),
        )
