...
if __name__ == '__main__':
    ...
    for epoch in range(max_epochs):
        ...
        if loss < prev_loss:
            torch.save(model.state_dict(), '/jhcnas1/zhoutaichang/cnn_model_.pt')  # save model parameters to files
            prev_loss = loss
            best_epoch = epoch
    ...
    plt.savefig('/jhcnas1/zhoutaichang/cnn_fig.png', format='png')